      ...
      <div className="why-dba-bottom">
        <div className="why-dba-inner-container">
          ...
          <div className="why-dba-p">
            ...
            <p className="main-p">
              ...
              time’s slotted to you)
            </p>
            <p className="main-p">
              If you’re earning a doctorate in your schedule while gaining
        ...
        <div className="why-dba-inner-container">
          ...
          <div className="why-dba-p">
            <p className="main-p">
              ...
              will imply that you’re an influential leader.
            </p>
            <p className="main-p">
            ...
            <p className="main-p">
              ...
              <span className=" designed-p">
                (💡Your industry experience will help solve 50% of your research
                proposal)
              </span>
            </p>
            <p className="main-p">
              Whereas a PhD doesn’t account for reality and lives only in
              theory. Studying 100s of articles and lecturing them back, which’s
        ...
        <div className="why-dba-inner-container">
          ...
          <div className="why-dba-p">
            ...
            <p className="main-p">
              —solving complex business issues is almost second nature to the
              DBA graduates.
            </p>
            <p className="main-p">
        ...
        <div className="why-dba-inner-container">
          ...
          <div className="why-dba-p">
            <p className="main-p">
              Unless you want to sacrifice social life in your PhD…{" "}
            </p>
            <p className="main-p">
              {" "}
              Here at SSM, you’ll not write all day. We believe any DBA
              leadership course focusing only on your thesis shouldn’t be
              accredited. Business leaders aren’t shut down to write +50,000
            ...
            <p className="main-p"> Once you finalize a research proposal … </p>
            <p className="main-p">
              {" "}
        ...
        <div className="why-dba-inner-container">
          ...
          <div className="why-dba-p">
            <p className="main-p">
              DBA’s credibility to publish is much greater than a PhD grad
            ...
            <p className="main-p">
              {" "}
              You’ll appear in recognized publications by voicing your opinions…
